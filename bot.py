...
async def show_admin(
    ...
    await query.edit_message_text(
        ...
        f"وضعیت ربات: {status}\n"
        f"👑 مالک: {get_owner_id()}\n\n"
        "💰 از گزینه «شارژ موجودی» "
        "برای افزایش موجودی کاربران استفاده کنید.",
